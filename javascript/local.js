...
data = d3.json("https://raw.githubusercontent.com/ben-tiki/d3_globe/main/data/world.json")
...
data.then(function(data) {
    ...
    .on("mouseover", function(d) {
        ...
        country_data = d3.csv("https://raw.githubusercontent.com/ben-tiki/d3_globe/main/data/world_population.csv")
